...
- **Multiple clients** — a browser SPA in this repo, plus a terminal UI and SSH-served TUI in the companion [taillight-tui](https://github.com/lasseh/taillight-tui) repo — all consume the same SSE streams.
...
- A terminal UI client (`taillight-tui`) and an SSH server that hosts it (`taillight-wish`) live in the companion repo **[taillight-tui](https://github.com/lasseh/taillight-tui)** — both are HTTP/SSE clients of this API
...
**[taillight-tui](https://github.com/lasseh/taillight-tui)**. Both are HTTP/SSE
