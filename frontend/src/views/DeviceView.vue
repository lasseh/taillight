    ...
    <template v-else-if="summary">
      ...
      <div class="shrink-0 space-y-4 p-4">
        ...
        <div class="flex items-center justify-between">
          ...
          <RouterLink
            :to="{ name: 'srvlog', query: { hostname: summary.hostname } }"
            class="text-t-teal text-xs hover:underline"
          >
            view all logs &rarr;
          </RouterLink>
            ...
            <div class="-mx-4">
              ...
              >
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <div class="min-w-0 truncate text-xs leading-snug" v-html="highlightMessage(`srvlog:${msg.latest_id}`, msg.sample)" />
                </div>
              </RouterLink>
              <!-- Desktop: full row -->
              <RouterLink
              ...
              >
                ...
                <span class="min-w-0 flex-1 truncate" :title="msg.sample" v-html="highlightMessage(`srvlog:${msg.latest_id}`, msg.sample)" />
              </RouterLink>
            </div>
          </div>
