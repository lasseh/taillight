...
<template>
  <div class="flex flex-1 flex-col gap-8 overflow-y-auto p-4">
    <!-- Loading state -->
    <div v-if="home.loading && !home.syslogSummary" class="text-t-fg-dark py-8 text-center text-sm">
      Loading...
    </div>

    <!-- Error state -->
    <div v-if="home.error" class="text-t-red py-8 text-center text-sm">
      {{ home.error }}
    </div>

    <!-- ═══════════════════════════ SYSLOG SECTION ═══════════════════════════ -->
    <section v-if="home.syslogSummary">
    ...
    <!-- ═══════════════════════════ APP LOG SECTION ═══════════════════════════ -->
    <section v-if="home.applogSummary">
