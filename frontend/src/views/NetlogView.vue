...
const hasMore = computed(() => Boolean(event.value?.structured_data || event.value?.raw_message))
    ...
    <div class="flex-1 overflow-y-auto px-4 py-4">
      ...
      <div v-else-if="event" class="mx-auto max-w-7xl space-y-4" @copy="onCopy">
        ...
        <div v-if="juniperRefs.length > 0" class="bg-t-bg-dark border-t-border rounded border">
          ...
          >
            <div class="mb-2 flex items-center gap-2">
              ...
              <span class="bg-t-green/15 text-t-green rounded px-1.5 py-0.5 text-xs">{{
                ref.os
              }}</span>
        ...
        <template v-if="hasMore">
          ...
          <div
            v-if="showMore && event.structured_data"
            class="bg-t-bg-dark border-t-border rounded border"
          >
            <h3
              class="text-t-fg-dark border-t-border border-b px-4 py-2 text-xs font-semibold uppercase tracking-wide"
            >
          ...
          <div
            v-if="showMore && event.raw_message"
            class="bg-t-bg-dark border-t-border rounded border"
          >
            <h3
              class="text-t-fg-dark border-t-border border-b px-4 py-2 text-xs font-semibold uppercase tracking-wide"
