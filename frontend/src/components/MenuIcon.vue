...
// Inline SVG sprite for AppHeader nav items so each icon is authored once
// and shared between the desktop dropdown and the mobile panel.
...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'edit-dashboard'">
      <rect x="3" y="3" width="7" height="7" />
      <rect x="14" y="3" width="7" height="7" />
      <rect x="3" y="14" width="7" height="7" />
      <rect x="14" y="14" width="7" height="7" />
    </template>
    <template v-else-if="name === 'api-keys'">
      <path
