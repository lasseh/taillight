...
import { ref, computed, nextTick, toRef, inject, watch, type Component } from 'vue'
...
// Shared srvlog/netlog event row. The two feeds are identical except for the
// detail component, filter store, and highlight identifier, which arrive as
