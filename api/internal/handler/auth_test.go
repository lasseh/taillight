...
func (m *mockAuthStore) UpsertOIDCUser(_ context.Context, _, _, _, _ string, _ bool) (model.User, error) {
	return m.user, m.userErr
}
...
func TestLogin(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h := NewAuthHandler(tt.store, nil, nil, false)
...
func TestRevokeUserSessions(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequestWithContext(context.Background(), http.MethodPost, "/users/"+tt.userID+"/revoke-sessions", nil)
			if tt.user != nil {
				req = req.WithContext(auth.WithUser(req.Context(), tt.user))
			}
			rec := httptest.NewRecorder()
...
func TestMe(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h := NewAuthHandler(&mockAuthStore{}, nil, nil, false)
...
func TestRevokeKey(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequestWithContext(context.Background(), http.MethodDelete, "/keys/"+tt.keyID, nil)
			if tt.user != nil {
				req = req.WithContext(auth.WithUser(req.Context(), tt.user))
			}
			rec := httptest.NewRecorder()
