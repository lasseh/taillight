...
func TestGetChannel(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodGet, "/channels/"+tt.id, nil)
			rec := httptest.NewRecorder()
			r.ServeHTTP(rec, req)
...
func TestCreateChannel(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h := NewNotificationHandler(tt.store, nil)
			req := httptest.NewRequest(http.MethodPost, "/api/v1/notifications/channels", bytes.NewBufferString(tt.body))
...
func TestUpdateChannel(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodPut, "/channels/"+tt.id, bytes.NewBufferString(tt.body))
			req.Header.Set("Content-Type", "application/json")
			rec := httptest.NewRecorder()
			r.ServeHTTP(rec, req)
...
func TestDeleteChannel(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodDelete, "/channels/"+tt.id, nil)
			rec := httptest.NewRecorder()
			r.ServeHTTP(rec, req)
...
func TestListRules(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h := NewNotificationHandler(tt.store, nil)
			req := httptest.NewRequest(http.MethodGet, "/api/v1/notifications/rules", nil)
			rec := httptest.NewRecorder()
...
func TestGetRule(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodGet, "/rules/"+tt.id, nil)
			rec := httptest.NewRecorder()
			r.ServeHTTP(rec, req)
...
func TestCreateRule(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h := NewNotificationHandler(tt.store, nil)
			req := httptest.NewRequest(http.MethodPost, "/api/v1/notifications/rules", bytes.NewBufferString(tt.body))
			req.Header.Set("Content-Type", "application/json")
			rec := httptest.NewRecorder()
...
func TestUpdateRule(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodPut, "/rules/"+tt.id, bytes.NewBufferString(tt.body))
			req.Header.Set("Content-Type", "application/json")
			rec := httptest.NewRecorder()
			r.ServeHTTP(rec, req)
...
func TestDeleteRule(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodDelete, "/rules/"+tt.id, nil)
			rec := httptest.NewRecorder()
			r.ServeHTTP(rec, req)
...
func TestListLog(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			h := NewNotificationHandler(tt.store, nil)
			req := httptest.NewRequest(http.MethodGet, "/api/v1/notifications/log"+tt.query, nil)
			rec := httptest.NewRecorder()
