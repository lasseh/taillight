-- Netlog events hypertable, indexes, triggers, meta caches, and continuous aggregate.
...
CALL remove_columnstore_policy('netlog_events');
...
ALTER MATERIALIZED VIEW netlog_summary_hourly SET (
    timescaledb.enable_columnstore,
    timescaledb.segmentby = 'hostname, severity',
    timescaledb.orderby = 'bucket DESC'
);
CALL add_columnstore_policy('netlog_summary_hourly', after => INTERVAL '3 days');
