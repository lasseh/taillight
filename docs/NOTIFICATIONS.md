...
See the [Interactive API Docs](http://localhost:8080/api/docs) (Scalar/OpenAPI UI) for the full endpoint reference, request/response schemas, and try-it-out functionality.
