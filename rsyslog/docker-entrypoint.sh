...
# RSYSLOG_ENABLE_CONTAINER_DEFAULTS=0 is set in docker-compose.yml to prevent
# rsyslog 8.2504+ from auto-loading imuxsock and /var/log/syslog rules when
# running as PID 1 (which fails as non-root).
if [ "$1" = "rsyslogd" ]; then
